...
function addOne(task,x,dateToDo) {
    ...
    $.ajax({
        url: "http://192.168.1.16:3000/add",
        type: "POST",
        data : {"title" : task , "description" : desc ,"currentDate" : x, "locationToDo" :  { "name": a.display_name , "lon" : a.lon ,"lat" : a.lat } ,"dateToDo" : dateToDo , "isComplete" : false },
